package com.pulmwine.processweb.aidl.mainpro;
...
import com.pulmwine.processweb.command.CommandsManager;
...
public class MainProAidlInterface extends IWebAidlInterface.Stub {
    ...
    private void handleRemoteAction(int level, final String actionName, Map paramMap, final IWebAidlCallback callback) throws Exception {
        CommandsManager.getInstance().findAndExecNonUICommand(context, level, actionName, paramMap, new ResultCallback() {
            @Override
